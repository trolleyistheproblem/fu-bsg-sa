...
doc = """
This is a twelve-period public goods game with 5 players. Assignment to groups is
random.

"""

class Constants(BaseConstants):
    name_in_url = 'pavancontrol'
    players_per_group = 4
    num_rounds = 12
...
class Group(BaseGroup):
	...
	def set_payoffs2(self):
		self.total_contribution = sum([p.contribution for p in self.get_players()])  + Constants.player_4_contribution
		self.individual_share = self.total_contribution * Constants.efficiency_factor / (Constants.players_per_group + 1)
